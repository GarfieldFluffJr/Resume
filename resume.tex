...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeProjectHeading
        ...
        \resumeItemListStart
          \resumeItem{Processed \textbf{2+ million data points} using OpenAI Batch API to allow LLaMa fine-tuned LLM to generate recipes, reducing processing time to 6 hours and \textbf{saving approximately \$1000}}
